...
NOW_GATEWAY_VERSION = '0.0.1-refactor-custom-gateway-73'
NOW_PREPROCESSOR_VERSION = '0.0.122-refactor-custom-gateway-73'
NOW_ELASTIC_INDEXER_VERSION = '0.0.144-refactor-custom-gateway-73'
NOW_AUTOCOMPLETE_VERSION = '0.0.10-refactor-custom-gateway-73'
